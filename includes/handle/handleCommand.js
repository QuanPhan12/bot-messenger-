...
//// admin -pa /////
  ...
  const noleak = moment.tz("Asia/Ho_Chi_Minh").format("(DD/MM/YYYY)  (HH:mm:ss)");
      const urls = [
  'https://nguyenvantien.online/api/anime.php',
...
const array = await Promise.all(urls.map(async url => {
 ...
 return downloadfile;
      ...
      const res = await axios.get(`https://nguyenvantien.online/api/anime.php`);
...
url: (await global.nodemodule["axios"]('https://webapi.vanthuan.name.vn/images/anime')).data.url,
method: "GET",
responseType: "stream"
})).data
...
url: (await global.nodemodule["axios"]('https://nguyenvantien.online/api/anime.php')).data.url,
method: "GET",
responseType: "stream"
