...
var f = Math.floor(Math.random() * 100) + 50; 
  ...
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            var t = Date.parse("September 30, 2023 00:00:00") - Date.parse(new Date()),
...
module.exports.run = async ({  
    ...
    let data = (await Currencies.getData(senderID)).data || {};
    var   t = Date.parse("September 30, 2023") - Date.parse(new Date()),
    d = Math.floor( t/(1000*60*60*24) ),
    h = Math.floor( (t/(1000*60*60)) % 24 ),
    m = Math.floor( (t/1000/60) % 60 );
    ...
    if (typeof data !== "undefined" && cooldown - (Date.now() - data.work2Time) > 0) {
        ...
        var msg = {
            body: "ㅤㅤ 🏮=== 𝐋𝐈̀ 𝐗𝐈̀ ===🏮" +
                ...
                "\n𝟓.🐼-> 𝐁𝐚𝐨 𝐥𝐢̀ 𝐱𝐢̀ 𝟓 🧧" +
                "\n𝟔.🐼-> 𝐁𝐚𝐨 𝐥𝐢̀ 𝐱𝐢̀ 𝟔 🧧" +
                `\n━━━━━━━━━━━━━━━\n🧨 𝐇𝐚̃𝐲 phản hồi 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐜𝐡𝐨̣𝐧 𝐛𝐚𝐨 𝐥𝐢̀ 𝐱𝐢̀ 𝐦𝐮𝐨̂́𝐧 𝐧𝐡𝐚̣̂𝐧.`,
