...
"https://i.postimg.cc/P5sLnhdx/onehit-30-5-2016-3.gif",
   ...
   var callback = () => api.sendMessage({body:`${tag}` + ` Bem vô mặt chó mày nè chừa cái tật sên si nhe 👿`,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/spair.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/spair.gif"));  
