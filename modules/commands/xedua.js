...
module.exports.config = {
  ...
  credits: "NVTIEN", // Công nh��n module sở hữu là ai
...
module.exports.languages = {
  "vi": {
    ...
    "fail": "『 🌸 』➝ Chỉ chọn %1 -> %2",
    "shopCar": "💮=『 SHOP CAR 』=💮\n\n──────────────\n➴『 1.』 Kawasaki-Z1000 \n🐼-> Giá: %1 đô\n➴『 2.』 Ducati-Monster-795  \n🐼-> Giá: %1 đô\n➴『 3.』 Aprilia-RSV4  \n🐼-> Giá: %1 đô\n➴『 4.』 Yamaha-YZF-R1  \n🐼-> Giá: %1 đô\n➴『 5.』 CBR-650R  \n🐼-> Giá: %1 đô\n━━━━━━━━━━━━━━━\n『 🌸 』➝ Phản hồi tin nhắn này để mua xe!",
    ...
    "userCar": "💮==『 Kho Xe 』==💮\n%1\n『 🌸 』➝ Phản hồi tin nhắn này để xem thông tin xe của bạn",
    "carInfo": "💮=『 %1 』=💮\n🐼-> Tốc độ: %2\n🐼-> Máy xe cấp: %3\n🐼-> Lọc nhớt cấp: %4\n🐼-> Bugi cấp: %5\n🐼-> Lọc gió cấp: %6",
    ...
    "chooseCar": "『 🌸 』➝ Phản hồi tin nhắn này để chọn xe!\n%1",
