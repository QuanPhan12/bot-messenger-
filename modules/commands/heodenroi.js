    ...
    switch (args[0]) {
        ...
        case '-r': {
            ...
            if (!existsSync(pathData)) {
                ...
                return api.sendMessage("⚔️ Đăng kí thành công", threadID, messageID);
            } else return api.sendMessage("⚔️ Bạn đã có trong cơ sở dữ liệu⚔️", threadID, messageID);
        ...
        case 'spin': {
            ...
            if(i == 3) {
                ...
                msg += '『 🌸 』➝ Vui lòng phản hồi với lựa chọn bạn muốn trộm!!'
