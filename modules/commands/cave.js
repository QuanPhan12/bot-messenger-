...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "cave.png")) request("https://i.imgur.com/MJg71zs.jpeg").pipe(fs.createWriteStream(dirMaterial + "cave.png"));
}
  ...
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                case "1": msg = `『 🌸 』➝ 𝐁𝐚̣𝐧 𝐕𝐮̛̀𝐚 𝐍𝐡𝐚̣̂𝐧 ${a}$ 𝐊𝐡𝐢 ngủ qua đêm với admin của ALICE 🌸` ;
                ...
                break;
                case "4": msg = `『 🌸 』➝ 𝐁𝐚̣𝐧 𝐕𝐮̛̀𝐚 𝐍𝐡𝐚̣̂𝐧 ${x}$ 𝐊𝐡𝐢 𝐂𝐡𝐢̣𝐜𝐡 𝐍𝐡𝐚𝐮 𝐕𝐨̛́𝐢 admin của ALICE 😽`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x)); 
                break;
                case "5": msg = `『 🌸 』➝ 𝐁𝐚̣𝐧 𝐕𝐮̛̀𝐚 𝐍𝐡𝐚̣̂𝐧 ${y}$ 𝐊𝐡𝐢 hôn admin của ALICE 🌚`; 
...
module.exports.run = async ({  
    ...
    if (typeof data !== "undefined" && cooldown - (Date.now() - data.work2Time) > 0) {
        ...
        return api.sendMessage(`『 🌸 』➝ 𝐁𝐚̣𝐧 𝐕𝐮̛̀𝐚 𝐏𝐡𝐢̣𝐜𝐡 𝐑𝐨̂̀𝐢 𝐓𝐫𝐚́𝐧𝐡 𝐁𝐢̣ Kiệt Sức, 𝐕𝐮𝐢 𝐋𝐨̀𝐧𝐠 𝐐𝐮𝐚𝐲 𝐋𝐚̣𝐢 𝐒𝐚𝐮 𝐍𝐠𝐚̀𝐲 𝐌𝐚𝐢`, e.threadID, e.messageID); // Đoạn này ae có thể để quay lại sau ${housr}giờ ${minutes}phút ${seconds}giây
    }
    else {    
        var msg = {
            body: "🏮=====𝐏𝐇𝐎̂́ 𝐇𝐎𝐀 𝐊𝐈𝐄̂̀𝐔=====🏮" +
                ...
                "\n𝟓.🐼-> 𝐏𝐡𝐨̂́ 𝐓𝐚𝐦 𝐓𝐫𝐢𝐧𝐡 🐥" +
                "\n𝟔.🐼-> 𝐊𝐡𝐚́𝐜𝐡 𝐒𝐚̣𝐧 𝐘 𝐍𝐮 💈" +
                `\n━━━━━━━━━━━━━━━\n𝐇𝐚̃𝐲 Phản Hồi 𝐒𝐓𝐓 𝐂𝐡𝐨̣𝐧 𝐊𝐡𝐮 𝐕𝐮̛̣𝐜 𝐇𝐚̀𝐧𝐡 𝐍𝐠𝐡𝐞̂̀ ❤️`,
