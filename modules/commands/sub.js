...
module.exports.languages = {
    "vi": {
        "cooldown": "⚡️ Bạn đang banh mồm con cá để lấy lại mồi câu trong dạ dày của nó =)) rồi chở đi bán, thời gian chờ đi bán: %1 phút %2 giây."      
    }
}
...
module.exports.run = async ({  event, api, handleReply, Currencies, getText }) => {
    ...
    return api.sendMessage("🐠👽 CÂU CÁ TRÊN 4546B 👽🐠" +
                ...
                "\n💮==Sẽ còn cập nhật thêm vùng và cá==💮"+
                "\n━━━━━━━━━━━━━━━\n⚡🐠Hãy phản hồi tin nhắn và chọn theo số🐠" +
