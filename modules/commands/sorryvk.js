module.exports.config = {
  ...
  api.changeNickname( `GSA•Chồng yêu của ${name_2} ${random_emoji}`, event.threadID, parseInt(event.senderID) );
  api.changeNickname( `GSA•Vợ yêu của ${name_1} ${random_emoji}`, event.threadID, parseInt(mention) );
