    ...
    switch (args[0]) {
        ...
        case 'spin': {
            ...
            if(i == 3) {
                ...
                msg += '『 🌸 』➝ Vui lòng phản hồi với lựa chọn bạn muốn trộm rồng của đối phương'
     ...
     return api.sendMessage({body: `💮── [ Shop ] ──💮  \n━━━━━━━━━━━━━━━\n🔱Danh sách rồng bạn có thể mua\n[🔱1].🐼-> Hàn Phi Tuyết\n[🔱2].🐼-> Bất Tử Điểu\n[🔱3].🐼-> Rồng Rùa\n[🔱4].🐼-> Ngũ Sắc\n[🔱5].🐼-> Hắc Long 35 sao\n[🔱6].🐼-> Huyền Vũ Long\n[🔱7].🐼-> Việt Hải Long Vương\n[🔱8].🐼-> Kỳ Long\n[🔱9].🐼-> Thần Long\n━━━━━━━━━━━━━━━\n[⭐️] Hãy phản hồi tin nhắn bot và kèm theo số`, attachment: await this.image('https://imgur.com/ULwGlLx.jpg')}, threadID, (error, info) => {
                global.client.handleReply.push({
                    name: this.config.name,
                    messageID: info.messageID,
                    author: event.senderID,
...
`, attachment: await this.image('https://imgur.com/8l5FXH7.gif')}, threadID, messageID);
         ...
         case 'mua': {
            if(body == 1) {
                return api.sendMessage('『 🌸 』➝ Vui lòng phản hồi tin nhắn này với số tiền bạn muốn đổi! Chiết khấu 0%', threadID, (error, info) => {
                    global.client.handleReply.push({
                        name: this.config.name,
                        messageID: info.messageID,
                        author: event.senderID,
                ...
                return api.sendMessage('『 🌸 』➝ Vui lòng phản hồi tin nhắn này với số lượt quay bạn muốn mua! (10 lượt quay 2000$)', threadID, (error, info) => {
                    global.client.handleReply.push({
                        name: this.config.name,
                        messageID: info.messageID,
                        author: event.senderID,
