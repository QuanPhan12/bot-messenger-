...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("Waifu")==0 || (event.body.indexOf("waifu")==0)) {
...
const fs = global.nodemodule["fs-extra"];
  ...
  "https://i.pinimg.com/originals/41/23/f2/4123f28655aa4874a956d2ba0147e296.jpg",
     ...
     var callback = () => api.sendMessage({body:``,attachment: fs.createReadStream(__dirname + "/noprefix/waifu.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/noprefix/waifu.jpg"), event.messageID);  
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/noprefix/waifu.jpg")).on("close",() => callback());
}
                                                                                                         }
